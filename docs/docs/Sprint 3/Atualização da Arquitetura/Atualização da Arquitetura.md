...
### 4.1 Diagrama da Arquitetura de Ingestão de Dados e Armazenamento
...
## 5. Fluxo de dados dos Sensores IoT (tempo real)
...
---
## 7.Diagrama da Arquitetura da Aplicação
...
## 8. Fluxo de acesso do usuário ao frontend
